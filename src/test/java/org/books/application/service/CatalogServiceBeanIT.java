...
public class CatalogServiceBeanIT {
    ...
    @Test
    public void searchBookNotFoundNew() {
        LOGGER.info(">>>>>>>>>>>>>>>>>>> Catalog searchBookNotFoundNew <<<<<<<<<<<<<<<<<<<<");
    ...
    @Test
    public void searchBookNew() {
        LOGGER.info(">>>>>>>>>>>>>>>>>>> Catalog searchBookNew <<<<<<<<<<<<<<<<<<<<");

        List<BookInfo> books = service.searchBooks("Nachtigall");
    ...
    @Test
    public void searchISBNNew() throws BookNotFoundException {
        LOGGER.info(">>>>>>>>>>>>>>>>>>> Catalog searchISBNNew <<<<<<<<<<<<<<<<<<<<");

        foundBook = service.findBook("0672337452");

        assertNotNull(foundBook);
        assertEquals(foundBook.getIsbn(), "0672337452");
    }
